...
public class DistanceTransformParallelBenchmark
{
	...
	public static void main( final String... args ) throws InterruptedException, ExecutionException, IOException
	{
		...
		final String source = "/home/hanslovskyp/Dropbox/misc/distance-transform-benchmark/butterfly/source.jpg";
...
//		imp.show();
		...
		{
			final String targetDir = "/home/hanslovskyp/Dropbox/misc/distance-transform-benchmark/butterfly/" + dType.toString();
